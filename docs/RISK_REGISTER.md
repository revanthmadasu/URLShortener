...
| R3 | **Open redirect / SSRF** — attacker shortens a link to an internal address | M×H | Redirect target validated at creation: scheme allowlist (`http`/`https`), block private/loopback/link-local ranges. | Mitigated (Phase 2) |
